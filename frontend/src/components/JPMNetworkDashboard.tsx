...
const initialNodes: Node<NodeData>[] = [
  // Level 1: Consulting Firms
  {
    id: 'c1', type: 'consultant', position: { x: 100, y: 50 },
    data: { 
      label: 'McKinsey & Company', type: 'consultant',
      properties: { firm: 'McKinsey & Company', specialization: 'Digital Banking Strategy', experience: 12, status: 'Active' } 
    }
  },
  {
    id: 'c2', type: 'consultant', position: { x: 350, y: 50 },
    data: { 
      label: 'Boston Consulting Group', type: 'consultant',
      properties: { firm: 'Boston Consulting Group', specialization: 'Investment Management', experience: 10, status: 'Active' } 
    }
  },
  {
    id: 'c3', type: 'consultant', position: { x: 600, y: 50 },
    data: { 
      label: 'Deloitte Financial Services', type: 'consultant',
      properties: { firm: 'Deloitte Financial Services', specialization: 'Risk & Compliance', experience: 8, status: 'Active' } 
    }
  },
  {
    id: 'c4', type: 'consultant', position: { x: 850, y: 50 },
    data: { 
      label: 'Accenture Financial Services', type: 'consultant',
      properties: { firm: 'Accenture Financial Services', specialization: 'Technology Implementation', experience: 15, status: 'Active' } 
    }
  },
  
  // Level 2: Field Consultants
  {
    id: 'fc1', type: 'fieldconsultant', position: { x: 175, y: 200 },
    data: { 
      label: 'Sarah Mitchell', type: 'fieldconsultant',
      properties: { region: 'North America', specialization: 'Consumer Banking', status: 'On Assignment' } 
    }
  },
  {
    id: 'fc2', type: 'fieldconsultant', position: { x: 475, y: 200 },
    data: { 
      label: 'James Anderson', type: 'fieldconsultant',
      properties: { region: 'EMEA', specialization: 'Investment Banking', status: 'Available' } 
    }
  },
  {
    id: 'fc3', type: 'fieldconsultant', position: { x: 775, y: 200 },
    data: { 
      label: 'Lisa Chen', type: 'fieldconsultant',
      properties: { region: 'APAC', specialization: 'Asset Management', status: 'On Assignment' } 
    }
  },
  ...
  // Level 3: Business Lines
  {
    ...
    data: { 
      ...
      properties: { industry: 'Retail Banking', assetSize: '$2.3T AUM', status: 'Active Implementation' } 
    }
  },
  {
    id: 'cl2', type: 'client', position: { x: 350, y: 350 },
    data: { 
      label: 'JPM Investment Bank', type: 'client',
      properties: { industry: 'Investment Banking', assetSize: '$3.7T Assets', status: 'Strategy Review' } 
    }
  },
  {
    id: 'cl3', type: 'client', position: { x: 600, y: 350 },
    data: { 
      label: 'JPM Asset Management', type: 'client',
      properties: { industry: 'Asset Management', assetSize: '$2.6T AUM', status: 'Product Rollout' } 
    }
  },
  {
    id: 'cl4', type: 'client', position: { x: 850, y: 350 },
    data: { 
      label: 'Corporate & Investment Bank', type: 'client',
      properties: { industry: 'Corporate Banking', assetSize: '$1.8T Assets', status: 'Technology Upgrade' } 
    }
  },
  
  // Level 4: Products
  {
    id: 'p1', type: 'product', position: { x: 50, y: 520 },
    data: { 
      label: 'JPM Digital Wallet', type: 'product',
      properties: { 
        category: 'Consumer Banking', businessLine: 'Chase', version: '4.2.1', status: 'Production',
        consultantRatings: [
  ...
  {
    id: 'p2', type: 'product', position: { x: 300, y: 520 },
    data: { 
      label: 'Investment Analytics Platform', type: 'product',
      properties: { 
        category: 'Investment Management', businessLine: 'Asset Management', version: '3.1.0', status: 'Beta Testing',
        consultantRatings: [
  ...
  {
    id: 'p3', type: 'product', position: { x: 550, y: 520 },
    data: { 
      label: 'Risk Management Suite', type: 'product',
      properties: { 
        category: 'Risk & Compliance', businessLine: 'Corporate Banking', version: '2.3.2', status: 'Production',
        consultantRatings: [
  ...
  {
    id: 'p4', type: 'product', position: { x: 800, y: 520 },
    data: { 
      label: 'Trading Platform Next-Gen', type: 'product',
      properties: { 
        category: 'Trading Technology', businessLine: 'Investment Banking', version: '5.0.1', status: 'Production',
        consultantRatings: [
...
// Colorful edges showing the tree hierarchy
const initialEdges: Edge[] = [
  // Level 1 to 2: Consultants to Field Consultants
  { id: 'e1', source: 'c1', target: 'fc1', label: 'ADVISES', style: { stroke: '#6366f1', strokeWidth: 3 } },
  { id: 'e2', source: 'c1', target: 'fc2', label: 'ADVISES', style: { stroke: '#6366f1', strokeWidth: 3 } },
  { id: 'e3', source: 'c2', target: 'fc2', label: 'ADVISES', style: { stroke: '#6366f1', strokeWidth: 3 } },
  { id: 'e4', source: 'c2', target: 'fc3', label: 'ADVISES', style: { stroke: '#6366f1', strokeWidth: 3 } },
  { id: 'e5', source: 'c3', target: 'fc1', label: 'SUPPORTS', style: { stroke: '#8b5cf6', strokeWidth: 3 } },
  { id: 'e6', source: 'c3', target: 'fc3', label: 'SUPPORTS', style: { stroke: '#8b5cf6', strokeWidth: 3 } },
  { id: 'e7', source: 'c4', target: 'fc1', label: 'IMPLEMENTS', style: { stroke: '#10b981', strokeWidth: 3 } },
  { id: 'e8', source: 'c4', target: 'fc2', label: 'IMPLEMENTS', style: { stroke: '#10b981', strokeWidth: 3 } },
  
  // Level 2 to 3: Field Consultants to Business Lines
  { id: 'e9', source: 'fc1', target: 'cl1', label: 'SERVES', style: { stroke: '#f59e0b', strokeWidth: 3 } },
  { id: 'e10', source: 'fc1', target: 'cl4', label: 'SERVES', style: { stroke: '#f59e0b', strokeWidth: 3 } },
  { id: 'e11', source: 'fc2', target: 'cl2', label: 'SERVES', style: { stroke: '#f59e0b', strokeWidth: 3 } },
  { id: 'e12', source: 'fc2', target: 'cl3', label: 'SERVES', style: { stroke: '#f59e0b', strokeWidth: 3 } },
  { id: 'e13', source: 'fc3', target: 'cl3', label: 'SERVES', style: { stroke: '#f59e0b', strokeWidth: 3 } },
  { id: 'e14', source: 'fc3', target: 'cl4', label: 'SERVES', style: { stroke: '#f59e0b', strokeWidth: 3 } },
  
  // Level 3 to 4: Business Lines to Products
  { id: 'e15', source: 'cl1', target: 'p1', label: 'USES', style: { stroke: '#ef4444', strokeWidth: 3 } },
  { id: 'e16', source: 'cl2', target: 'p4', label: 'USES', style: { stroke: '#ef4444', strokeWidth: 3 } },
  { id: 'e17', source: 'cl3', target: 'p2', label: 'USES', style: { stroke: '#ef4444', strokeWidth: 3 } },
  { id: 'e18', source: 'cl4', target: 'p3', label: 'USES', style: { stroke: '#ef4444', strokeWidth: 3 } },
  
  // Cross-connections
  { id: 'e19', source: 'cl1', target: 'p3', label: 'EVALUATES', style: { stroke: '#64748b', strokeWidth: 2, strokeDasharray: '5,5' } },
  { id: 'e20', source: 'cl2', target: 'p2', label: 'EVALUATES', style: { stroke: '#64748b', strokeWidth: 2, strokeDasharray: '5,5' } },
];
...
const JPMNetworkDashboard: React.FC = () => {
  ...
  const handleSendMessage = (): void => {
    ...
    setTimeout(() => {
      const response: ChatMessage = {
        ...
        type: 'bot',
        text: `I've analyzed "${currentMessage}" within JPM's consultant network. The data shows relationships between consulting firms, implementation teams, business divisions, and product ratings.`,
        cypher: generateMockCypher(currentMessage),
        timestamp: new Date(),
        actions: [
          { label: "Show details", prompt: `Provide more details about: ${currentMessage}` },
          { label: "Related insights", prompt: "Show me related network patterns" }
        ]
      };
                  ...
                  <Stack spacing={3}>
                    <FormControl fullWidth size="small">
                      ...
                      <Select value={nodeTypeFilter} label="Node Type" onChange={(e) => setNodeTypeFilter(e.target.value)}>
                        ...
                        <MenuItem value="fieldconsultant">Field Consultants</MenuItem>
                    ...
                    <Card sx={{ mt: 2 }}>
                      <CardContent>
                        ...
                        <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 2 }}>
                          ...
                          <Box sx={{ textAlign: 'center' }}>
                            <Typography variant="h4" color="success.main">$10.4T</Typography>
...
export default JPMNetworkDashboard;